...
for arch in amd64 arm64; do
  for cmd in frontend live-input-verify materializer record-verify release-manifest release-verify test-runner resolve runtime-base-evidence snapshot-proxy bottle-fetcher catalog-service catalog-extractor; do
