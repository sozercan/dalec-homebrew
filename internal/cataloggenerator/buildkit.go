...
func verifyExtractedTap(extracted *catalogextractor.ExtractedTap, tap catalog.TapID) error {
	if extracted == nil {
		return errors.New("isolated tap extraction returned nil metadata")
	}
