...
func options() Options {
	...
	return Options{SpecDigest: digest.FromString("spec").String(), Now: tm, Metadata: metadata.SnapshotInfo{Digest: d, FormulaDigest: d, MigrationDigest: d, GeneratedAt: tm, FetchedAt: tm, Formula: metadata.DocumentInfo{URL: "https://example/formula", EnvelopeDigest: d, GeneratedAt: tm, GeneratedAtSource: metadata.GeneratedAtSignedPayload, Signatures: []metadata.SignatureInfo{{KeyID: "homebrew-1", Algorithm: "PS512", Verified: true}}}, Migrations: metadata.DocumentInfo{URL: "https://example/migrations", EnvelopeDigest: d, GeneratedAt: tm, GeneratedAtSource: metadata.GeneratedAtSignedPayload, Signatures: []metadata.SignatureInfo{{KeyID: "homebrew-1", Algorithm: "PS512", Verified: true}}}}, Runtime: resolution.RuntimePolicy{User: "linuxbrew", UID: 1000, GID: 1000, CPUBaseline: "core2"}, Attestation: resolution.AttestationPolicy{Waiver: "test"}}
}
