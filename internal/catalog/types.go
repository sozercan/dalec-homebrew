...
const BuildLocalArtifactPolicyVersion = "build-local-artifact-v1"
...
// LocalTransport binds generated bytes carried directly by the current
// content-addressed BuildKit solve. It is accepted only for policy-authorized
// prebuilt-derived bottles and requires retained bytes for replay.
