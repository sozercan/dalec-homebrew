...
const (
	...
	PrebuiltArchiveFormatTarGzip          = "tar+gzip"
	PrebuiltELFFormatELF64                = "elf64"
	PrebuiltELFMachineX8664               = "x86_64"
	PrebuiltELFMachineAArch64             = "aarch64"
	VerifiedProvenancePolicy              = "sigstore-in-toto-v1"
	ChecksumProvenanceWaiver              = "tap-catalog-buildkit-and-verified-checksum-v1"
	PrebuiltProvenanceWaiver              = "prebuilt-archive-buildkit-and-verified-checksum-v1"
	...
	MaxPrebuiltArchiveEntries             = 4096
	MaxPrebuiltArchiveExpandedBytes int64 = 4 << 30
	MaxPrebuiltFormulaSourceBytes   int64 = 4 << 20
	MaxRedirects                          = 5
	MaxJSONDepth                          = 128
